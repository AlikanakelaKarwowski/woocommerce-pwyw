...
Plugin URI: 
Description: Custom plugin created by Guy Lyons to add a "Pay what you want option" to woocommerce. Forked from his project and changed for my needs.
Author: Alex Karwowski
Forked: https://github.com/guylyons/woocommerce-pwyw
Version: 1.0.1
